 ...
 *
 * Future enhancement:
 * Instead of selecting a part then selecting modify - I believe double clicking a part opens the selected parts page with for modification.
 * This would eliminate the need for modify button and the runtime error would not exist when no part was selected.
 *
 */
public class MainFormController implements Initializable{
     ...
     *      modPart event - If no items are in the parts table and modify part is selected then a run time error occurs.
     *      Correction to runtime error was to implement a "if" statement with an alarm letting the user know the error occurred and why.
     *
     * @param event
     */
    @FXML
