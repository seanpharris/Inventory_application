...
public class Inv{
     ...
     * @param prodToUpdate
     */
    public void updateProd(Product prodToUpdate){
        IntStream.range(0,allProd.size()).filter(i -> allProd.get(i).getProdID()==prodToUpdate.getProdID()).findFirst().ifPresent(i -> allProd.set(i,prodToUpdate));
    }
